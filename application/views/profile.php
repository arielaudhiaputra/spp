								...
								<form action="<?= base_url('profile'); ?>" method="post">
									...
									<div class="card-body border-top py-0 my-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <?php if($profile['level'] == "Murid"): ?>
                                                    <div class="form-group">
                                                        <label for="id_kelas">Kelas : </label>
                                                        <input value="<?= $user['nama_kelas']; ?>"  class="form-control" disabled>
                                                ...
                                                <?php else: ?>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $user['no_telp'] ?>" name="no_telp" id="no_telp"  class="form-control" placeholder="Masukana No.Telp">
                                        ...
                                        <?php if($user['level'] == "Murid"): ?>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-4">
                                                    <div class="form-group">
                                                        <label for="nisn">NISN : </label>
                                                        <input type="text" value="<?= $user['nisn'] ?>" name="nisn" id="nisn"  class="form-control" placeholder="Masukan NISN" disabled>
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $user['nis'] ?>" name="nis" id="nis"  class="form-control"  placeholder="Masukana NIS" disabled>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-6">
												<div class="form-group">
													...
													<input type="text" value="<?= $user['email'] ?>" name="email" id="email"  class="form-control" placeholder="Masukan Email">
                            ...
                            <?= form_open_multipart('profile/update_photo'); ?>
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <img src="<?= base_url('assets/img/profile/'). $user['photo']; ?>" alt="Photo Profil" width="200px">
                                    </div>

                                    <div class="card-footer">
                                        <div class="custom-file mb-3">
                                            <input type="file" name="photo" class="custom-file-input" value="<?= $user['photo'] ?>" id="photo" aria-describedby="photo">
